...
namespace Home_demo_app.Server.Migrations
{
    ...
    [Migration("20250103170630_updappointment")]
    partial class updappointment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Home_demo_app.Server.Models.Owner_module.Appointment", b =>
                {
                    ...
                    b.HasOne("Home_demo_app.Server.Models.Domain.User_Reg", null)
                        .WithMany("Appointments")
                        .HasForeignKey("User_RegId");
