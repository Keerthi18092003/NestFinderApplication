...
export class ViewListingComponent {
  ...
  viewAppointments(propertyId: string): void {
    console.log(`Viewing appointments for propertyId: ${propertyId}`);
    // Redirect to appointments page or open a modal
    // Example: 
    this.router.navigate(['/viewappointments'], { queryParams: { propertyId } });
  }
